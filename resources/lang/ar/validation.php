...
'label_about_us_ar'        => 'نبذة عنا (بالعربية)',
    'label_about_us_en'        => 'نبذة عنا (بالإنجليزية)',
    'label_contact_ar'         => 'معلومات التواصل (بالعربية)',
    'label_contact_en'         => 'معلومات التواصل (بالإنجليزية)',
    'label_service_ar'         => 'خدماتنا (بالعربية)',
    'label_service_en'         => 'خدماتنا (بالإنجليزية)',
    ...
    'description_service_en'   => 'وصف قسم الخدمات (بالإنجليزية)',
    'description_service_ar'   => 'وصف قسم الخدمات (بالعربية)',
    'description_about_us_en'  => 'وصف قسم نبذة عنا (بالإنجليزية)',
